...
const page = () => {
  return (
    <div className="min-h-screen pt-18 bg-gradient-to-br from-blue-50 via-slate-50 to-white py-4 px-2">
      <div className="max-w-6xl mx-auto bg-white rounded-2xl shadow-2xl border border-blue-100 px-6 md:px-12 py-10 md:py-14 mt-16 mb-10">
        <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-xl p-5 md:p-7 mb-8 shadow-sm">
          <h1 className="text-3xl md:text-4xl font-extrabold text-blue-900 mb-2 tracking-tight">Privacy Policy</h1>
          <p className="mb-2 text-base md:text-lg text-gray-700">
            This Privacy Policy governs the Websites operated by Cilicosys. (hereinafter, "us", "we", or “Cilicosys”), including, without limitation, the Website currently located at <a href="https://www.cilicosys.com" className="text-blue-700 underline break-all hover:text-blue-900">https://www.cilicosys.com</a>, By using the Website, you consent to the collection and use of your personal information as outlined in this Privacy Policy.
          </p>
        ...
        <section className="mb-8">
          <h2 className="text-xl md:text-2xl font-bold text-blue-700 border-l-4 border-blue-100 pl-3 bg-blue-50 rounded mb-3">1. Website Visitors</h2>
        ...
        <section className="mb-8">
          <h2 className="text-xl md:text-2xl font-bold text-blue-700 border-l-4 border-blue-100 pl-3 bg-blue-50 rounded mb-3">2. Gathering of Information</h2>
          <p className="text-gray-700 mb-3">
        ...
        <section className="mb-8">
          <h2 className="text-xl md:text-2xl font-bold text-blue-700 border-l-4 border-blue-100 pl-3 bg-blue-50 rounded mb-3">3. Legal Basis for Processing Personal Data</h2>
        ...
        <section className="mb-8">
          <h2 className="text-xl md:text-2xl font-bold text-blue-700 border-l-4 border-blue-100 pl-3 bg-blue-50 rounded mb-3">4. User Rights Under GDPR</h2>
          <ul className="list-disc pl-6 text-gray-700 mb-3 space-y-2">
        ...
        <section className="mb-8">
          <h2 className="text-xl md:text-2xl font-bold text-blue-700 border-l-4 border-blue-100 pl-3 bg-blue-50 rounded mb-3">5. Security</h2>
          <p className="text-gray-700 mb-3">
        ...
        <section className="mb-8">
          <h2 className="text-xl md:text-2xl font-bold text-blue-700 border-l-4 border-blue-100 pl-3 bg-blue-50 rounded mb-3">6. Data Retention</h2>
          <p className="text-gray-700 mb-3">
            We retain personal data only for as long as necessary to fulfill the purposes for which it was collected or as required by law.
          </p>
        </section>
        <section className="mb-8">
          <h2 className="text-xl md:text-2xl font-bold text-blue-700 border-l-4 border-blue-100 pl-3 bg-blue-50 rounded mb-3">7. Cookies</h2>
          <p className="text-gray-700 mb-3">
        ...
        <section className="mb-2">
          <h2 className="text-xl md:text-2xl font-bold text-blue-700 border-l-4 border-blue-100 pl-3 bg-blue-50 rounded mb-3">8. Contact Us</h2>
          <p className="text-gray-700">
            For questions or to exercise your GDPR rights, contact us at: <a href="mailto:info@cilicosys.com" className="text-blue-700 underline hover:text-blue-900">info@cilicosys.com</a>
          </p>
        </section>
      </div>
    </div>
