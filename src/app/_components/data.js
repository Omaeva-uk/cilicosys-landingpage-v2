const heroData = {
    heading: "Strategic Insights and customized IT Solutions",
    heroPara: "Your one-stop IT solutions firm, transforming challenges into innovative, technology-driven outcomes.",
}


const socialProofData = [
    "/assets/social-proof-section/sp-1.png",
    "/assets/social-proof-section/sp-2.png",
    "/assets/social-proof-section/sp-3.png",
    "/assets/social-proof-section/sp-4.png",
    "/assets/social-proof-section/sp-5.png",
...
const aboutData = {
    heading: "We are more than just an IT consultancy.",
    para: "We are enablers of transformation, pioneers of cutting-edge solutions, and collaborators in your growth. As a visionary and client-focused organization, we are committed to redefining possibilities and equipping businesses to thrive in a technology-driven world.",
    img: "/assets/about-us-section/about-right-img.png",
    stats: [
        {
            id: 1,
            highlight: "12+",
            para: "Years of expertise in IT consulting and services.",
        },
        {
            id: 2,
            highlight: "50+",
            para: "Successful projects transforming businesses globally.",
        },
    ]
}
...
const ctaData = {
    heading: "Let’s transform your IT landscape today.",
    para: "Take the first step towards a brighter future by transforming your business with innovative IT solutions, expert consultancy, and dedicated support.",
}


const footerData = {
    address: "No.29, Sita, Vinayaka Layout., 1st Stage, Basaveswara Nagar., Bangalore - 560079",
    contactNumber: "+91 80 4804 0022",
    mail: "info@cilicosys.com"
}


export {heroData, socialProofData, aboutData, servicesData, testimonialData, ctaData, footerData};